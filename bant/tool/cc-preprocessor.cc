/* Generated by re2c 4.5.1 on Mon Jun 29 19:10:19 2026 */
...
#line 102 "<stdout>"
    ...
    yy1:
      ++YYCURSOR;
    yy2:
#line 246 "bant/tool/cc-preprocessor.re"
    {
      continue;
    }
#line 123 "<stdout>"
    yy3:
      ++YYCURSOR;
#line 239 "bant/tool/cc-preprocessor.re"
      {
...
#line 131 "<stdout>"
    ...
    yy14:
      ++YYCURSOR;
#line 211 "bant/tool/cc-preprocessor.re"
      {
...
#line 222 "<stdout>"
    yy15:
      ++YYCURSOR;
#line 204 "bant/tool/cc-preprocessor.re"
      {
...
#line 230 "<stdout>"
    ...
    yy25:
      ...
      d_end = YYCURSOR;
      d_end -= 1;
#line 224 "bant/tool/cc-preprocessor.re"
      {
...
#line 539 "<stdout>"
    ...
    yy35:
      ...
      pound_start = yyt1;
      v_end = YYCURSOR;
#line 142 "bant/tool/cc-preprocessor.re"
      {
...
#line 675 "<stdout>"
    ...
    yy38:
      ...
      v_start = yyt2;
      v_end = YYCURSOR;
#line 108 "bant/tool/cc-preprocessor.re"
      {
        if (!all_space(start_of_line, pound_start)) continue;
...
#line 767 "<stdout>"
    ...
    yy43:
      ++YYCURSOR;
      pound_start = yyt1;
#line 154 "bant/tool/cc-preprocessor.re"
      {
        if (!all_space(start_of_line, pound_start)) continue;
        if (!condition_stack.empty()) {
...
#line 804 "<stdout>"
    ...
    yy53:
      ...
      v_start = yyt3;
      v_end = YYCURSOR;
#line 122 "bant/tool/cc-preprocessor.re"
      {
        if (!all_space(start_of_line, pound_start)) continue;
        ...
        if (is_ifndef && condition_stack.empty() &&
            maybe_header_guard.empty()) {
...
#line 1146 "<stdout>"
    ...
    yy56:
      ...
      k_start = yyt2;
      k_end = YYCURSOR;
#line 182 "bant/tool/cc-preprocessor.re"
      {
        if (!all_space(start_of_line, pound_start)) continue;
...
#line 1235 "<stdout>"
    ...
    yy58:
      ...
      v_start = yyt4;
      v_end = yyt5;
#line 164 "bant/tool/cc-preprocessor.re"
      {
        if (!all_space(start_of_line, pound_start)) continue;
        const std::string_view macro(k_start, k_end - k_start);
...
#line 1336 "<stdout>"
    ...
    yy60:
      ...
      case 'x':
      case 'y':
      case 'z': yyt4 = YYCURSOR; goto yy64;
      default: goto yy9;
      }
    yy61:
      yych = *++YYCURSOR;
...
#line 1441 "<stdout>"
    yy64:
      ...
      case 'y':
      case 'z': goto yy64;
      default: yyt5 = YYCURSOR; goto yy58;
      }
    }
#line 249 "bant/tool/cc-preprocessor.re"
  }
